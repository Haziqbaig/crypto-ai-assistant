/**
 * indicators.js — Technical indicator engine for CryptoSage AI.
...
const Indicators = (() => {
  ...
  /** MACD(12,26,9): returns { macd[], signal[], histogram[], cross } where cross ∈ 'bullish'|'bearish'|'none' (most recent cross within 5 bars). */
  ...
  /**
   * Simple support/resistance from swing lows/highs over the window.
   * Uses local extrema (fractal, 2-bar wings); falls back to min/max.
  ...
  /**
   * Compute the full indicator snapshot from a daily price series.
  ...
  return { sma, ema, rsi, macd, bollinger, supportResistance, analyze };
})();
